...
ONLYONET.Resources = {
    ...
    "box-blockchain-connect-description":"The end-to-end encryption mode is enabled. All your DOCX, XLSX, PPTX, ODT, ODS, ODP and PDF files will be encrypted. Open, create, edit and co-edit documents privately and securely.",
    "box-blockchain-connect-header":"Your blockchain account info",
    "box-blockchain-info-btn-refresh": "Update Account Information",
    ...
    "dlg-vault-mnemonic-caption":"Create your account",
    ...
    "dlg-vault-new-password-msg-error-1":"Your password is less than 8 characters",    
    ...
    "dlg-vault-description-line2":"* Password must consist of minimum 8 characters. For additional security, we recommend using a combination of lowercase and uppercase letters, numbers and symbols. Do not use personal information (name, birth date, etc.) in your password to protect it from hacking.",
