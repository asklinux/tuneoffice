...
namespace PPTX
{
	namespace Logic
	{
		void AnimEffect::fromXML(XmlUtils::CXmlNode& node)
		{
		...
		std::wstring AnimEffect::toXML() const
		{
		...
		OOX::EElementType AnimEffect::getType() const
		{
			return OOX::et_p_animEffect;
		}
		void AnimEffect::toXmlWriter(NSBinPptxRW::CXmlWriter* pWriter) const
		{
			pWriter->WriteString(toXML());
		}
		void AnimEffect::toPPTY(NSBinPptxRW::CBinaryFileWriter* pWriter) const
		{
		...
		void AnimEffect::fromPPTY(NSBinPptxRW::CBinaryFileReader* pReader)
		{
