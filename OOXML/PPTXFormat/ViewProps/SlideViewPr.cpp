...
namespace PPTX
{
	...
	{
		void SlideViewPr::fromXML(XmlUtils::CXmlNode& node)
		{
			CSldViewPr = node.ReadNode(L"p:cSldViewPr");

			FillParentPointersForChilds();
		}
		std::wstring SlideViewPr::toXML() const
		{
		...
		void SlideViewPr::toPPTY(NSBinPptxRW::CBinaryFileWriter* pWriter) const
		{
			pWriter->WriteRecord1(0, CSldViewPr);
		}
		void SlideViewPr::fromPPTY(NSBinPptxRW::CBinaryFileReader* pReader)
		{
		...
		void SlideViewPr::toXmlWriter(NSBinPptxRW::CXmlWriter* pWriter) const
		{
