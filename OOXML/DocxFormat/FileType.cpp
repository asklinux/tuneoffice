...
namespace OOX
{
		FileType::FileType(const CPath& defaultDirectory, const CPath& defaultFileName,
							const std::wstring& overrideType,
							const std::wstring& relationType,
							const std::wstring& enumerateType, bool bEnumerated, bool bEnumeratedGlobal)
		...
		FileType::FileType(const std::wstring& defaultDirectory, const std::wstring& defaultFileName,
							const std::wstring& overrideType,
							const std::wstring& relationType,
							const std::wstring& enumerateType, bool bEnumerated, bool bEnumeratedGlobal)
		:	m_defaultDirectory(defaultDirectory),
