...
namespace XLSB
{
    ...
    class BeginSlicerStyle: public XLS::BiffRecord
    {
            BIFF_RECORD_DEFINE_TYPE_INFO(BeginSlicerStyle)
            BASE_OBJECT_DEFINE_CLASS_NAME(BeginSlicerStyle)
        public:
            BeginSlicerStyle();
            ~BeginSlicerStyle();
            ...
            //static const XLS::ElementType	type = XLS::typeBeginSlicerStyle;
