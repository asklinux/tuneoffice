...
namespace XLSB
{
    // Logical representation of BrtSxvcellNum record in BIFF12
    class SxvcellNum: public XLS::BiffRecord
    {
            BIFF_RECORD_DEFINE_TYPE_INFO(SxvcellNum)
        ...
        public:
            ...
            static const XLS::ElementType	type = XLS::typeSxvcellNum;
