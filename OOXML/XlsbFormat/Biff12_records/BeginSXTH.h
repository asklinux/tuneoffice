...
namespace XLSB
{
    // Logical representation of BrtBeginSXTH record in BIFF12
    class BeginSXTH: public XLS::BiffRecord
    {
            BIFF_RECORD_DEFINE_TYPE_INFO(BeginSXTH)
            BASE_OBJECT_DEFINE_CLASS_NAME(BeginSXTH)
        public:
            BeginSXTH();
            ~BeginSXTH();
