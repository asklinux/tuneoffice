...
#include "ISXTHCOLS.h"
#include "../Biff12_records/BeginISXTHCols.h"
#include "../Biff12_records/EndISXTHCols.h"
...
namespace XLSB
{
    ...
    BaseObjectPtr ISXTHCOLS::clone()
    {
        return BaseObjectPtr(new ISXTHCOLS(*this));
    }

    //ISXTHCOLS = BrtBeginISXTHCols BrtEndISXTHCols
    const bool ISXTHCOLS::loadContent(BinProcessor& proc)
    {
        if (proc.optional<BeginISXTHCols>())
        {
            m_BrtBeginISXTHCols = elements_.back();
            elements_.pop_back();
        }
