...
#include "SXTHITEM.h"
#include "../Biff12_records/BeginSXTHItem.h"
#include "../Biff12_records/EndSXTHItem.h"
...
namespace XLSB
{
    ...
    BaseObjectPtr SXTHITEM::clone()
    {
        return BaseObjectPtr(new SXTHITEM(*this));
    }

    //SXTHITEM = BrtBeginSXTHItem BrtEndSXTHItem
    const bool SXTHITEM::loadContent(BinProcessor& proc)
    {
        if (proc.optional<BeginSXTHItem>())
        {
            m_BrtBeginSXTHItem = elements_.back();
            elements_.pop_back();
        }
