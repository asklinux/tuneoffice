...
#include "PCDSOURCE14.h"
#include "../Biff12_records/FRTBegin.h"
#include "../Biff12_records/PivotCacheConnectionName.h"
...
namespace XLSB
{
    ...
    BaseObjectPtr PCDSOURCE14::clone()
    {
        return BaseObjectPtr(new PCDSOURCE14(*this));
    }

    //PCDSOURCE14 = [BrtFRTBegin BrtPivotCacheConnectionName BrtFRTEnd] *FRT
    const bool PCDSOURCE14::loadContent(BinProcessor& proc)
    {
        ...
        if (proc.optional<PivotCacheConnectionName>())
        {
            m_BrtPivotCacheConnectionName = elements_.back();
            elements_.pop_back();
        }
