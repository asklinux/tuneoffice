...
#include "PNPAIR.h"
#include "../Biff12_records/BeginPNPair.h"
#include "../Biff12_records/EndPNPair.h"
...
namespace XLSB
{
    ...
    BaseObjectPtr PNPAIR::clone()
    {
        return BaseObjectPtr(new PNPAIR(*this));
    }

    //PNPAIR = BrtBeginPNPair BrtEndPNPair
    const bool PNPAIR::loadContent(BinProcessor& proc)
    {
        if (proc.optional<BeginPNPair>())
        {
            m_BrtBeginPNPair = elements_.back();
            elements_.pop_back();
        }
