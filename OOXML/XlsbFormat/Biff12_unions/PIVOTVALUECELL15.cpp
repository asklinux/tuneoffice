...
#include "../Biff12_records/SxvcellDate.h"
#include "../Biff12_records/SxvcellNil.h"
...
namespace XLSB
{
    ...
    PIVOTVALUECELL15::PIVOTVALUECELL15()
    {
    }
    ...
    BaseObjectPtr PIVOTVALUECELL15::clone()
    {
            ...
            if (!proc.optional<SxvcellStr>())
                if (!proc.optional<SxvcellErr>())
                    if (!proc.optional<SxvcellBool>())
                        if (!proc.optional<SxvcellDate>())
                            if (!proc.optional<SxvcellNil>())
                                return false;
