...
#include "../Biff12_records/BeginOleObjects.h"
#include "../Biff12_records/OleObject.h"
#include "../Biff12_records/EndOleObjects.h"
...
namespace XLSB
{
    ...
    BaseObjectPtr OLEOBJECTS::clone()
    {
        return BaseObjectPtr(new OLEOBJECTS(*this));
    }
    ...
    const bool OLEOBJECTS::loadContent(BinProcessor& proc)
    {
        ...
        while(count > 0)
        {
            m_arBrtOleObject.insert(m_arBrtOleObject.begin(), elements_.back());
            elements_.pop_back();
            count--;
        }
