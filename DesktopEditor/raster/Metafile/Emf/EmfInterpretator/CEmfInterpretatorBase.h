...
namespace MetaFile
{
	...
	public:
		...
		virtual void HANDLE_EMR_SETTEXTCOLOR(const TRGBA&) = 0;
		...
		virtual void HANDLE_EMR_MOVETOEX(const TPointL&) = 0;
		virtual void HANDLE_EMR_SETARCDIRECTION(const unsigned int&) = 0;
		virtual void HANDLE_EMR_FILLPATH(const TRectL&) = 0;
		virtual void HANDLE_EMR_SETMAPMODE(const unsigned int&) = 0;
		virtual void HANDLE_EMR_SETWINDOWORGEX(const TPointL&) = 0;
		virtual void HANDLE_EMR_SETWINDOWEXTEX(const TSizeL&) = 0;
		virtual void HANDLE_EMR_SCALEWINDOWEXTEX(int, int, int, int) = 0;
		virtual void HANDLE_EMR_SETVIEWPORTORGEX(const TPointL&) = 0;
		virtual void HANDLE_EMR_SETVIEWPORTEXTEX(const TSizeL&) = 0;
		...
		virtual void HANDLE_EMR_SETBKCOLOR(const TRGBA&) = 0;
		virtual void HANDLE_EMR_EXCLUDECLIPRECT(const TRectL&) = 0;
		...
		virtual void HANDLE_EMR_INTERSECTCLIPRECT(const TRectL&) = 0;
		virtual void HANDLE_EMR_SETLAYOUT(const unsigned int&) = 0;
		virtual void HANDLE_EMR_SETBRUSHORGEX(const TPointL&) = 0;
		virtual void HANDLE_EMR_ANGLEARC(const TPointL&, const unsigned int&, const double&, const double&) = 0;
		virtual void HANDLE_EMR_ARC(const TRectL&, const TPointL&, const TPointL&) = 0;
		virtual void HANDLE_EMR_ARCTO(const TRectL&, const TPointL&, const TPointL&) = 0;
		virtual void HANDLE_EMR_CHORD(const TRectL&, const TPointL&, const TPointL&) = 0;
		virtual void HANDLE_EMR_ELLIPSE(const TRectL&) = 0;
		virtual void HANDLE_EMR_EXTTEXTOUTA(const TEmfExtTextoutA&) = 0;
		virtual void HANDLE_EMR_EXTTEXTOUTW(const TEmfExtTextoutW&) = 0;
		virtual void HANDLE_EMR_LINETO(const TPointL&) = 0;
		virtual void HANDLE_EMR_PIE(const TRectL&, const TPointL&, const TPointL&) = 0;
		virtual void HANDLE_EMR_POLYBEZIER(const TRectL&, const std::vector<TPointL>&) = 0;
		virtual void HANDLE_EMR_POLYBEZIER(const TRectL&, const std::vector<TPointS>&) = 0;
		virtual void HANDLE_EMR_POLYBEZIERTO(const TRectL&, const std::vector<TPointL>&) = 0;
		virtual void HANDLE_EMR_POLYBEZIERTO(const TRectL&, const std::vector<TPointS>&) = 0;
		virtual void HANDLE_EMR_POLYDRAW(const TRectL&, TPointL*, const unsigned int&, const unsigned char*) = 0;
		virtual void HANDLE_EMR_POLYDRAW(const TRectL&, TPointS*, const unsigned int&, const unsigned char*) = 0;
		virtual void HANDLE_EMR_POLYGON(const TRectL&, const std::vector<TPointL>&) = 0;
		virtual void HANDLE_EMR_POLYGON(const TRectL&, const std::vector<TPointS>&) = 0;
		virtual void HANDLE_EMR_POLYLINE(const TRectL&, const std::vector<TPointL>&) = 0;
		virtual void HANDLE_EMR_POLYLINE(const TRectL&, const std::vector<TPointS>&) = 0;
		virtual void HANDLE_EMR_POLYLINETO(const TRectL&, const std::vector<TPointL>&) = 0;
		virtual void HANDLE_EMR_POLYLINETO(const TRectL&, const std::vector<TPointS>&) = 0;
		virtual void HANDLE_EMR_POLYPOLYGON(const TRectL&, const std::vector<std::vector<TPointL>>&) = 0;
		virtual void HANDLE_EMR_POLYPOLYGON(const TRectL&, const std::vector<std::vector<TPointS>>&) = 0;
		virtual void HANDLE_EMR_POLYPOLYLINE(const TRectL&, const std::vector<std::vector<TPointL>>&) = 0;
		virtual void HANDLE_EMR_POLYPOLYLINE(const TRectL&, const std::vector<std::vector<TPointS>>&) = 0;
		// TODO: Implement saving polygons within a polygon
		virtual void HANDLE_EMR_RECTANGLE(const TRectL&) = 0;
		virtual void HANDLE_EMR_ROUNDRECT(const TRectL&, const TSizeL&) = 0;
		virtual void HANDLE_EMR_SETPIXELV(const TPointL&, const TRGBA&) = 0;
		virtual void HANDLE_EMR_SMALLTEXTOUT(const TEmfSmallTextout&) = 0;
		virtual void HANDLE_EMR_STROKEANDFILLPATH(const TRectL&) = 0;
		virtual void HANDLE_EMR_STROKEPATH(const TRectL&) = 0;
		...
		virtual void HANDLE_EMR_FILLRGN(const TRectL&, unsigned int, const TRegionDataHeader&, const std::vector<TRectL>&) = 0;
		virtual void HANDLE_EMR_PAINTRGN(const TRectL&, const TRegionDataHeader&, const std::vector<TRectL>&) = 0;
		virtual void HANDLE_EMR_FRAMERGN(const TRectL&, unsigned int, int, int, const TRegionDataHeader&, const std::vector<TRectL>&) = 0;
