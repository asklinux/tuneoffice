...
namespace MetaFile
{
	...
	private:
		...
		template<typename T> void Save_EMR_POLYDRAW_BASE(const TRectL& oBounds, T* arPoints, const unsigned int& unCount, const unsigned char* pAbTypes);
