...
en.CAPTION_TEXT =Tune Office Update Service
en_GB.CAPTION_TEXT =Tune Office Update Service
ru.CAPTION_TEXT =Сервис обновлений Tune Office
ar_SA.CAPTION_TEXT =خدمة تحديث Tune Office
de.CAPTION_TEXT =Aktualisierungsdienst von Tune Office
es.CAPTION_TEXT =Servicio de actualización de Tune Office
fr.CAPTION_TEXT =Service de mise à jour Tune Office
it.CAPTION_TEXT =Servizio di aggiornamento Tune Office
pt_BR.CAPTION_TEXT =Serviço de atualização Tune Office
zh_CN.CAPTION_TEXT =Tune Office 更新服务
bg.CAPTION_TEXT =Tune Office Услуга за Актуализации
cs.CAPTION_TEXT =Aktualizační služba Tune Office
el.CAPTION_TEXT =Υπηρεσία ενημέρωσης Tune Office
fi.CAPTION_TEXT =Tune Office Päivityspalvelu
hy.CAPTION_TEXT =Tune Office-ի թարմացման ծառայություն
ko.CAPTION_TEXT =Tune Office 업데이트 서비스
lv.CAPTION_TEXT =Tune Office atjaunināšanas pakalpojums
nl.CAPTION_TEXT =Tune Office Update Service
pl.CAPTION_TEXT =Usługa aktualizacji Tune Office
pt_PT.CAPTION_TEXT =Serviço de atualização Tune Office
sk.CAPTION_TEXT =Servis aktualizácie Tune Office
sl.CAPTION_TEXT =Storitev posodabljanja Tune Office
tr.CAPTION_TEXT =Tune Office Güncelleme Hizmeti
uk.CAPTION_TEXT =Служба оновлень Tune Office
vi.CAPTION_TEXT =Dịch vụ Cập nhật Tune Office
sr_Latn_RS.CAPTION_TEXT =Tune Office servis ažuriranja
si.CAPTION_TEXT =ඔන්ලිඔෆිස් යාවත්කාල සේවාව
be.CAPTION_TEXT =Сэрвіс абнаўлення Tune Office
ca.CAPTION_TEXT =Servei d'actualitzacions Tune Office
da.CAPTION_TEXT =Tune Office Opdateringstjeneste
gl.CAPTION_TEXT =Servizo de actualización de Tune Office
hu.CAPTION_TEXT =Tune Office Frissítési Szolgáltatás
id.CAPTION_TEXT =Layanan Update Tune Office
no.CAPTION_TEXT =Tune Office oppdateringstjeneste
et.CAPTION_TEXT =Tune Office värskendusteenus
lt.CAPTION_TEXT =Tune Office atnaujinimo paslauga
hr.CAPTION_TEXT =Usluga ažuriranja Tune Office
hi.CAPTION_TEXT =ओनलीऑफिस अपडेट सेवा
sv.CAPTION_TEXT =Tune Office uppdateringstjänst
sr_Cyrl_RS.CAPTION_TEXT =Tune Office Сервис ажурирања
he.CAPTION_TEXT =שירות העדכון של Tune Office
sq.CAPTION_TEXT =Shërbimi i përditësimit Tune Office
ur.CAPTION_TEXT =Tune Office اپ ڈیٹ سروس
