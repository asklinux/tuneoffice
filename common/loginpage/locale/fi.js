l10n.fi = {
    welWelcome: 'Tervetuloa TUNEOFFICE Työpöytä Editoriin!',
    welDescr: 'Työskentele ilman verkkoyhteyttä tai yhdistä pilveesi: TUNEOFFICE, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Luo TUNEOFFICE pilvi',
    ...
    portalEmptyAdv1: 'Eikö sinulla ole vielä pilveä? Ota yhteys verkkoon TUNEOFFICEN pilvipalvelulla ja <br />kokeile yhteistyö-mahdollisuuksia ilmaiseksi.',
    ...
    linkCreatePortal: 'Luo TUNEOFFICE pilvi',
    ...
    loginNoteAssignPhone: 'Kaksi-vaiheinen tunnistus on otettu käyttöön, tuomaan lisäturvaa TUNEOFFICEN pilveen. Syötä puhelinnumerosi, jatkaaksesi työskentelyä pilvi-officessa. Puhelinnumero tulee syöttää käyttäen kansainvälistä muotoa maatunnuksella.',
    ...
    emptySlide3Text: 'Säilö dokumenttisi TUNEOFFICEN pilveen ja käytä niitä million tahansa, missä tahansa.',
