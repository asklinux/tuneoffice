l10n.fr = {
    welWelcome: 'Bienvenue sur TUNEOFFICE Desktop Editors !',
    welDescr: 'Travaillez avec vos documents en mode hors-connexion ou connectez la suite à votre Cloud : TUNEOFFICE, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Créer un compte Cloud TUNEOFFICE',
    ...
    portalEmptyAdv1: 'Vous n\'avez pas encore de compte Cloud ? Accéder en ligne avec TUNEOFFICE et essayez les capacités de gestion collaborative gratuitement.',
    ...
    linkCreatePortal: 'Créer un compte Cloud TUNEOFFICE',
    ...
    emptySlide3Text: 'Stockez vos documents dans TUNEOFFICE Cloud et accedez-y depuis n\'importe où et à n\'importe quel moment.',
