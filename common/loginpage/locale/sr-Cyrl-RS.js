l10n.sr_Cyrl_RS = {
    welWelcome: 'Добро дошли у TUNEOFFICE Десктоп Уређиваче!',
    welDescr: 'Радите на документима офлајн или конектујте пакет на свој облак: TUNEOFFICE, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Креирај TUNEOFFICE облак',
    ...
    portalEmptyAdv1: 'Још увек немате облак рачун? Идите онлајн са TUNEOFFICE Облак сервисом и <br /> покушајте сарађивачке способности бесплатно.',
    ...
    linkCreatePortal: 'Креирај TUNEOFFICE облак',
    ...
    loginNoteAssignPhone: 'Двофакторска аутентикација је омогућена да обезбеди додатну TUNEOFFICE облак безбедност. Унесите свој број телефона да наставите рад на облак офис-у. Број мобилног телефона мора бити унет користећи интернационални формат са кодом државе.',
    ...
    emptySlide3Text: 'Складишти своје документе у TUNEOFFICE облаку и приступи им било када, са било ког места.',
