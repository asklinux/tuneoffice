l10n.cs = {
    welWelcome: 'Vítejte v TUNEOFFICE Desktop Editors!',
    welDescr: 'Práce na dokumentech offline nebo propojení sady do cloudu: TUNEOFFICE, ownCloud, Nextcloud.',
    welNeedHelp: 'Potřebujete pomoct? Navštivte naše $1.',
    textHelpCenter: 'Centrum nápovědy',
    btnConnect: 'Připojit',
    textHavePortal: 'Už používáte cloud?',
    btnCreatePortal: 'Vytvořit TUNEOFFICE cloud',
    ...
    portalEmptyAdv1: 'Nemáte ještě cloud účet? Navštivte službu Cloud Service TUNEOFFICE a vyzkoušejte možnosti spolupráce zdarma.',
    ...
    linkCreatePortal: 'Vytvořit TUNEOFFICE cloud',
    ...
    loginNoteAssignPhone: 'K zajištění další bezpečnosti TUNEOFFICE cloud je zapnuto dvoufaktorové ověřování. Zadejte své číslo mobilního telefonu, abyste mohli pokračovat v práci na kanceláře cloud. Číslo mobilního telefonu musí být zadáno pomocí mezinárodního formátu s kódem země.',
