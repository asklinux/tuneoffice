...
en.extDOCXF =Tune Office Form Template
en_GB.extDOCXF =Tune Office Form Template
ar_SA.extDOCXF =قالب استبيان Tune Office
bg.extDOCXF =Tune Office Шаблон на формуляр
ca.extDOCXF =Plantilla de formulari Tune Office
cs.extDOCXF =Šablona formuláře Tune Office
el.extDOCXF =Πρότυπο φόρμας εγγράφου Tune Office
;et.extDOCXF =Tune Office dokumendi vormi mall
fi.extDOCXF =Tune Office-asiakirjalomakemalli
;lt.extDOCXF =Tune Office Anketos Šablonas
lo.extDOCXF =ຮູບແບບຂອງ Tune Office
nl.extDOCXF =Tune Office Formulier Sjabloon
ru.extDOCXF =Шаблон формы Tune Office
de.extDOCXF =Tune Office-Formularvorlage
fr.extDOCXF =Modèle de formulaire Tune Office
es.extDOCXF =Plantilla de formulario Tune Office
id.extDOCXF =Templat Tune Office Form
it_IT.extDOCXF =Modello di modulo Tune Office
pt_BR.extDOCXF =Modelo de formulário do Tune Office
pt_PT.extDOCXF =Modelo de formulário Tune Office
pl.extDOCXF =Szablon formularza Tune Office
ro.extDOCXF =Șablon Formă Tune Office
sk.extDOCXF =Šablóna formulára Tune Office
sl.extDOCXF =Tune Office predloga obrazca
sv.extDOCXF =Tune Office formulärmall
tr.extDOCXF =Tune Office Belgesi Form Şablonu
vi.extDOCXF =Mẫu biểu mẫu tài liệu Tune Office
zh_CN.extDOCXF =Tune Office表单模板
hy_AM.extDOCXF =Tune Office փաստաթղթի ձևանմուշ
hr.extDOCXF =Tune Office Predložak obrasca
da.extDOCXF =Tune Office formularskabelon
;hi.extDOCXF =ओनलीऑफिस दस्तावेज़ फॉर्म टेम्पलेट
hu.extDOCXF =Tune Office formátum-sablon
;ga_IE.extDOCXF =Teimpléad Foirm Tune Office
ja.extDOCXF =Tune Office フォーム テンプレート
ko.extDOCXF =Tune Office 문서 양식 템플릿
lv.extDOCXF =Tune Office veidlapas veidne
no.extDOCXF =Tune Office-dokumentskjemamal
uk.extDOCXF =Шаблон форми Tune Office
be.extDOCXF =Шаблон формы Tune Office
gl.extDOCXF =Tune Office Modelo de Formulario
si.extDOCXF =ඔන්ලිඔෆිස් ආකෘතිපත්‍ර අච්චුව
zh_TW.extDOCXF =Tune Office 文档表单模板
sr_Cyrl_RS.extDOCXF =Tune Office формулар шаблон
sr_Latn_RS.extDOCXF =Tune Office formular šablon
he.extDOCXF =תבנית טופס Tune Office
sq.extDOCXF =Modeli i shablloni Tune Office
#if Ver >= EncodeVer(6,1,1)
ur.extDOCXF =Tune Office فارم ٹیمپلیٹ
#endif
