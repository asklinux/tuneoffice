...
`,r.storyName=`Link Label`,n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`() => \`
  <label class="header">Header label</label>
\``,...n.parameters?.docs?.source}}},r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`() => \`
  <label class="link">Link label</label>
\``,...r.parameters?.docs?.source}}},i=[`Header`,`Link`]}))();export{n as Header,r as Link,i as __namedExportsOrder,t as default};