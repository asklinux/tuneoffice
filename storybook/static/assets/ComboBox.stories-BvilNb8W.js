...
`,n.storyName=`ComboBox`,n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`() => \`
  <label class="header" for="select_example">ComboBox</label>
  <select id="select_example" class="">
    <option value="1">Item 1</option>
    <option value="2">Item 2</option>
...
\``,...n.parameters?.docs?.source}}},r=[`ComboBox`]}))();export{n as ComboBox,r as __namedExportsOrder,t as default};