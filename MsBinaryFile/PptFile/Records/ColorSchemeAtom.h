...
{
public:
    ODRAW::SColorAtom m_oBackgroundColor;
    ODRAW::SColorAtom m_oTextAndLinesColor;
    ODRAW::SColorAtom m_oShadowsColor;
    ODRAW::SColorAtom m_oTitleTextColor;
    ODRAW::SColorAtom m_oFillsColor;
    ...
    void ToArray(std::vector<ODRAW::CColor>* pArray);
};
}
