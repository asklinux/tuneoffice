...
s3_bucket = "repo-doc-tuneoffice-com"
s3_region = "eu-west-1"
s3_base_url = "https://s3.eu-west-1.amazonaws.com/repo-doc-tuneoffice-com"
...
if utils.is_macos():
  desktop_package_name = "TUNEOFFICE"
  desktop_build_dir = "desktop-apps/macos"
  desktop_branding_dir = "desktop-apps/macos"
  desktop_updates_dir = "build/update"
  desktop_changes_dir = "TUNEOFFICE/update/updates/TUNEOFFICE/changes"
  sparkle_base_url = "https://download.tuneoffice.com/install/desktop/editors/mac"
