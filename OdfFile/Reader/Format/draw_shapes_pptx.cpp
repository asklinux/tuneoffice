...
/////////////////////////////////////////////////////////////////////////////////
	...
	if (baseStyleInst)// presentation vector shape
	{
...
////////////////////////////////////////////////////////////////////////////////////
	...
	Context.get_text_context().set_svg_height_width(svg_heightVal, svg_widthVal);
...
void draw_caption::pptx_convert(oox::pptx_conversion_context & Context)
{
	...
	Context.get_slide_context().start_shape(sub_type_);// rect with fancy attributes.. like TextBox
