...
public:
	...
	void reset_polygon_path();// special case of svg - all points are connected by straight lines
};
...
public:
	...
	void reset_polyline_path();// special case of svg - all points are connected by straight lines
};
