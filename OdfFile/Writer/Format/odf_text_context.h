...
private:
	...
	paragraph_format_properties	*paragraph_properties_;	// storage-marker that properties are assigned to another, non-text object
	text_format_properties		*text_properties_;		// storage-marker that properties are assigned to another, non-text object
