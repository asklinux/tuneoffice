...
{
	sub_type_ = 2;//todooo move/relocate
...
void draw_path::reset_svg_path()//todooo reverse
{
	...
	//	{
	//		//generate xml-oox here... otherwise will have to create arrays in drawing.. even if not pretty..
...
{
	sub_type_ = 9; //connector - line, if polyline (determined below) - then path
