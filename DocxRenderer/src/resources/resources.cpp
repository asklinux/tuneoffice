...
bool CreateTemplate(const std::wstring& strDirectory)
{
	...
	NSStringUtils::string_replaceA(str_resource_app, "<Application>TUNEOFFICE</Application>", str_resource_app_replace_a);
