...
const config = {
  ...
  plugins: [
    new webpack.DefinePlugin({
      ...
      __SUPPORT_EMAIL__: JSON.stringify(process.env.SUPPORT_EMAIL || 'support@tuneoffice.com'),
      __SUPPORT_URL__: JSON.stringify(process.env.SUPPORT_URL || 'https://support.tuneoffice.com'),
      __PUBLISHER_PHONE__: JSON.stringify(process.env.PUBLISHER_PHONE || '+371 633-99867'),
      __PUBLISHER_URL__: JSON.stringify(process.env.PUBLISHER_URL || 'https://www.tuneoffice.com'),
      __PUBLISHER_NAME__: JSON.stringify(process.env.PUBLISHER_NAME || 'Ascensio System SIA'),
      __APP_TITLE_TEXT__: JSON.stringify(process.env.APP_TITLE_TEXT ? process.env.APP_TITLE_TEXT : 'TUNEOFFICE'),
      __COMPANY_NAME__: JSON.stringify(process.env.COMPANY_NAME ? process.env.COMPANY_NAME : 'TUNEOFFICE'),
      __HELP_URL__: JSON.stringify(process.env.HELP_URL || 'https://helpcenter.tuneoffice.com'),
      __SALES_EMAIL__: JSON.stringify(process.env.SALES_EMAIL || 'sales@tuneoffice.com'),
    }),
