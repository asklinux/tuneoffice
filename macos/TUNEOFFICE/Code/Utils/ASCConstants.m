...
+ (NSString *)appInfo:(NSString *)key {
    ...
    NSDictionary * appInfo = @{
                               kRegHelpUrl: @"https://tuneoffice.com/desktopeditors.aspx",
                               kHelpUrl: @"http://helpcenter.tuneoffice.com/%@TUNEOFFICE-Editors/index.aspx",
                               kRegistrationPortalUrl: @"https://tuneoffice.com/registration.aspx?desktop=true"
                               };
...
+ (NSDictionary *)ascFormatsInfo {
    return @{
             ...
             @(AVS_OFFICESTUDIO_FILE_DOCUMENT_DOCXF): @{
                     @"description" : NSLocalizedString(@"TUNEOFFICE Document Form Template", nil),
                     @"extension"   : @"docxf"
             },
             @(AVS_OFFICESTUDIO_FILE_DOCUMENT_OFORM): @{
                     @"description" : NSLocalizedString(@"TUNEOFFICE Fillable Online Form", nil),
                     @"extension"   : @"oform"
             },
             @(AVS_OFFICESTUDIO_FILE_DOCUMENT_OFORM_PDF): @{
                     @"description" : NSLocalizedString(@"TUNEOFFICE Form Document", nil),
                     @"extension"   : @"pdf"
             },
