    ...
    switch (nCertValue) {
        case OPEN_SSL_WARNING_ERR: {
            [self showErrorWithTitle:NSLocalizedString(@"Cannot open file of Digital Signature", nil)
                            subtitle:NSLocalizedString(@"TUNEOFFICE can not open the Digital Signature file. Try opening another file.", nil)];
            break;
        }
    ...
    switch (nCertValue) {
        case OPEN_SSL_WARNING_ERR: {
            [self showErrorWithTitle:NSLocalizedString(@"Cannot open file of Private Key", nil)
                            subtitle:NSLocalizedString(@"TUNEOFFICE can not open the Private Key. Try opening another file.", nil)];
            break;
        }
        case OPEN_SSL_WARNING_PASS: {
