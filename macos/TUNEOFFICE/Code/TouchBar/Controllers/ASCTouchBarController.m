...
static NSTouchBarCustomizationIdentifier const kScrubberCustomizationIdentifier = @"com.tuneoffice.touchbar.scrubberViewController";
static NSTouchBarItemIdentifier const kScrubbedItemIdentifier = @"com.tuneoffice.touchbar.item.scrubber";
static NSTouchBarItemIdentifier const kStartPageItemIdentifier = @"com.tuneoffice.touchbar.item.startpage";
static NSTouchBarItemIdentifier const kNewItemsItemIdentifier = @"com.tuneoffice.touchbar.item.newItems";
