...
static NSString * const kCreationButtonIdentifier  = @"com.tuneoffice.touchbar.button.new.%@";
static NSString * const kStartPageButtonIdentifier = @"com.tuneoffice.touchbar.button.startpage";
