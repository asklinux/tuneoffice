...
define([
    ...
    PDFE.Views.TableSettingsAdvanced = Common.Views.AdvancedSettingsWindow.extend(_.extend({
        options: {
            alias: 'TableSettingsAdvanced',
            contentWidth: 280,
            contentHeight: 300,
            storageName: 'pdfe-table-settings-adv-category',
    ...
    }, PDFE.Views.TableSettingsAdvanced || {}));
});