...
define([
    ...
    SSE.Views.ShapeSettings = Backbone.View.extend(_.extend({
        ...
        initialize: function () {
            ...
            this.ShapeColor = {Value: 1, Color: 'transparent'};  // value=1 - color is defined (transparent or other), value=0 - color is undefined, draw as transparent
            ...
            this.BorderColor = {Value: 1, Color: 'transparent'};  // value=1 - color is defined (transparent or other), value=0 - color is undefined, draw as transparent
            this.BorderSize = 0;
            this.BorderType = Asc.c_oDashType.solid;

            this.ShadowColor = {Value: 1, Color: 'transparent'};  // value=1 - color is defined (transparent or other), value=0 - color is undefined, draw as transparent
        ...
        ChangeSettings: function(props) {
            ...
            if (props && props.asc_getShapeProperties())
            {
                ...
                if (fill===null || fill_type===null) { // fill doesn't match across multiple shapes
                    ...
                    fill = fill.asc_getFill();
                    this.BlipFillType = fill.asc_getType(); // null - values don't match across multiple shapes
                    ...
                    fill = fill.asc_getFill();
                    this.PatternFillType = fill.asc_getPatternType(); // null - values don't match across multiple shapes
                    ...
                    fill = fill.asc_getFill();
                    var gradfilltype = fill.asc_getGradType();  // null - values don't match across multiple shapes
